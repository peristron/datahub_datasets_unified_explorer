...
def render_dataset_id_reference():
    ...
    st.success("✅ Dataset ID Reference loaded (test version)")
    st.info("Once this works, we can expand it to the full list.")

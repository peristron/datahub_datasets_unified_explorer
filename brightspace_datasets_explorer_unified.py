...
def render_dataset_id_reference():
    """Full Dataset ID Reference with complete hard-coded data."""
    st.header("📋 Brightspace Dataset ID Reference")
    st.caption("SchemaID + Full / Differential PluginIDs (stable across environments)")

    # Full hard-coded data - all lists have exactly the same length
    data = {
        "Dataset Name": [
            "SCORM Activity Attempts", "Activity Feed Post Objects", "System Access Summary",
            "Local Authentication Security Log", "Survey Objects", "Competency Activity Log",
            "System Access Log", "Quiz Attempts", "Assignment Submissions", "Rubric Assessment Criteria",
            "Attendance Sessions", "LTI Links", "Outcomes In Registries", "SIS Course Merge Log",
            "Outcomes Rubric Alignments", "LTI Advantage Deployment Audit", "Role Details",
            "Awards Issued", "Intelligent Agent Objects", "SCORM Objects", "Portfolio Categories",
            "Discussion Posts Read Status", "TurnItIn Submissions", "Checklist Objects",
            "Gradebook Settings", "Competency Log", "Course Publisher Recipients",
            "Competency Activity Results", "Intelligent Agent Run Users", "Activity Exemptions Log",
            "Tools", "User Attribute Definitions", "Enrollments and Withdrawals",
            "Content User Progress", "Outcomes Scale Definition", "Discussion Posts",
            "SCORM Interaction Objectives", "Organizational Unit Ancestors", "Grade Objects",
            "Rubric Objects", "Survey Attempts", "Announcements", "CPD User Targets",
            "Content User Completion", "Outcome Registry Owners", "Rubric Object Criteria",
            "Activity Feed Post Log", "Outcomes Assessed Checkpoints", "Intelligent Agent Run Log",
            "Accommodations Profile Log", "Content Objects", "Media Objects",
            "Checklist Category Details", "Question Relationships", "Calendar Events",
            "Competency Activities", "LTI Advantage Registration Audit", "Award Objects",
            "Attendance Registers", "Outcomes Course Specific Scales", "Content Files Properties Log",
            "Quiz Attempts Log", "Checklist Completions", "Survey User Answer Responses",
            "CPD Questions", "Creator+ Practices Adoption", "Assignment Summary",
            "Audio Video Processed", "Auditor Relationships Log", "Portfolio Evidence Categories",
        ...
        "SchemaID": [
            ...
            "c6ac3243-0c00-4e04-823f-483d68ea4d0d", "66dc53a4-4f62-4235-9727-af59f670f0b5",
            "ed15df0c-49e7-4ace-aeb3-22a415975a3f", "d33bfddd-5151-46f7-966e-0afa6023f300",
            "c3336250-30d1-45bc-809c-7b68b983f305", "a7d6e843-bf8d-4965-9274-95028f3c4d86",
            "a5686dc9-78fc-4495-ada4-50db954bebea", "7c01ead6-8011-4d04-8b9a-7289b731a9fc",
            "879a19b1-1b72-42b0-b0c5-1304331a6443", "7a0d551f-0bbb-4544-a077-e1c427a0e5f3",
            "99376909-7e3c-44cf-a723-76e50243a54d", "b9611500-29d6-471f-95ff-014a599e0e74",
            "a38958d0-f56b-49fd-90fe-c7e712c6e3f5", "56ab3878-f6ec-41a0-af94-3358fc85729a",
            "d70f64e0-ad63-4140-aac5-e337560b8371", "dcef8789-1e6b-4d98-ac76-588583b3ba30",
            "d336eec3-b1eb-41ef-8245-ff20ca98fe14", "d611f5e9-749e-4db0-b564-0549efe89d57",
            "6ef67fee-bc34-4a67-9ac5-75be0953b24b", "b4c8636c-b717-4422-97e3-aa40c9722e70",
            "ac48b6d1-6655-48e4-907b-61c0fdbb37d1", "d4a354f1-edfd-4443-9a86-95e219935a78",
            "4196a13f-4431-47d7-b2e0-a97197b5d18c", "b7bb72a8-2ae0-43a3-83e8-2d1a0f9165ca",
            "6fd5da94-5270-4359-a6b2-8d0896527c1f", "6cecdaab-bff9-484f-a0d9-61c558707fad",
            "a4f709a6-34ea-490d-bad1-22268db8c6ac", "6ed33466-03ce-4702-9402-d8089ccaf5cc",
            "81d4bd50-9db6-495d-93ed-a3dbb6597a61", "0d1f2f4b-1b61-4373-9e33-a99a8d8dbfd9",
            "05dc704d-2a2c-4bc6-8cf6-ee6b998dc2db", "2572cc01-77f8-481c-b2a6-907971ec2b83",
            "b3037586-4d6f-4069-a138-3d3069af9657", "f7c47f8b-35f2-466c-95e9-04c315ec07ff",
            "fd6d617f-f3bf-498a-a45e-c8db9d1c3615", "c0b0740f-896e-4afa-bfd9-81d8e43006d9",
            "dacc3bad-81ed-4cec-975f-88598c660f02", "c473942c-74e4-4ef2-83a6-638434a7db26",
            "c597fc3e-b7ee-4d30-af3f-a7c825cc59f3", "5b76e84f-189e-4c64-bcef-960c33b02a18",
            "4851cbfe-4fb4-47f0-b6c9-df4594cddae5", "b7f3452e-9cae-4172-ad03-f242f61d7c61",
            "cf6ef813-481d-45ac-8e4a-5df1e13863af", "fac02315-302f-41b8-8b07-10c00f7a8d1d",
            "2f22beed-81c7-4d99-9935-70eb30610084", "645fc68b-04a5-4d42-8282-be71e54b2068",
            "748e30e9-7a04-449e-a557-d1bde27f6c0a", "e1da7ff3-8578-4659-bb34-bb901d3a032c",
            "ae3fe47d-0fee-43cb-94b3-7e9e15c4e14e", "75c16f2d-a40f-42db-b8a4-314608320ccf",
            "e0541d86-16f0-492a-8fc7-1495f5bc69a4", "7a1a456f-3bd9-403e-bf04-a384036da3ae",
            "c68bce39-87ba-4a44-84c7-a2e8a3dab424", "b544c470-29a8-449e-9a77-7825388fbba4",
            "4f75c912-cb31-46a1-bf5c-61f983228f0c", "56fa41c5-142f-4b99-885a-a738d0a09d54",
            "9b1086cd-e527-4dc5-8687-98484c1553a8", "b4d68640-c259-481b-927c-90162f25fda1",
            "c73385ca-9ac4-439a-a625-bb473f450b49", "a8e9249d-3412-4dff-bfd4-758c66fd2f55",
            "decc7bbf-716c-44c1-9754-4356405fb9aa", "54d695fe-1c34-4fae-b1d5-a5923ca933a2",
            "9c0eba24-05e5-4ce5-a3cf-74c4b64b5b03", "45f8a83e-78e0-4444-8d3f-d242e35c7158",
            "16a36efe-0a07-4381-9570-6d8b391ac317", "3282ebf6-d8e2-477d-9ce0-99feae4c9778",
            ...
            "cc69b71f-5186-46c0-85ba-cb5e02e4fabc", "f7736415-b09e-4227-beed-1e559be1c40f",
            "61f0b972-63f6-42e4-b7db-5e55795360c0", "f4908e05-a9f0-413f-9c1b-01f44e04070d",
            "49907f5d-4de2-48dd-838c-5b143a5565c5", "ca9ba3aa-6207-41dc-a4cc-f75bf2b0ddda",
            "d3c500d0-c384-48b3-9770-70023a6b2ca7", "a89d5e34-b4d7-45ad-bbfa-7cc327aac819",
            "a5246ef3-66b2-4396-ba90-a145095ad5d2", "dc669c5d-30a0-489e-9ee5-8ef1e0307376",
            "fd57b574-f156-48ef-bc53-670e2b3d0f58", "9e167b3b-7a0b-470c-ad58-8a19f9c79e22",
            "ebc1b345-76b7-4daa-b07d-f2a892e32c7f", "bcd6ca2c-51b8-452f-a689-aacaf0e6726c",
        ...
        "Full PluginID": [
            ...
            "9200879f-d943-47c7-9e20-c5d0bd330707", "b8ada4c7-d5d7-4377-bf8a-81718978ba01",
            "6bb3c6c2-7a61-44df-a081-d8762d93a3b5", "dd43a7db-801d-4fb3-b8f9-f94844e012f6",
            "5813e618-49ec-4e5c-90e7-1fb4fe4b59c6", "f1623581-c5d7-4562-93fe-6ad16010c96b",
            "041dde83-3a29-4a37-97de-9ee615318111", "612e3196-52ad-42bd-b460-8b850f7a7be1",
            "78035701-db72-463b-9dc8-a6f3eed2041e", "e00227de-5563-4c89-80f7-c6847eafe6f9",
            "eb28c5ce-d299-4ba0-9956-fe94b6e4fd30", "270a2afa-1f09-439c-b0df-f83b166b0dbd",
            "aed60e0d-1f4a-4c2c-b129-57be73fbadf8", "581ecbef-ca17-48c0-853b-c275c7aaf4f1",
            "bd61f20b-be91-4b93-b449-46361e2c323f", "6d6cd2d8-c714-41fd-9465-f797dfd69c76",
            "b069488a-aff7-42f2-828c-14bb0f71f3f4", "ff5813ca-87f7-4def-983d-a2a88c42dbb4",
            "45da28c2-81f9-4b31-ad7c-edbc1838ae63", "ac51124b-6038-4b04-a186-92eb4cef40b0",
            "e4b3d080-b4f8-4d6c-abf3-98bf887829bc", "96a69e76-1045-4e06-8517-5783a844b50e",
            "c3672b39-846e-49bf-8cf4-69015a8f15c1", "1f2ca72d-f39d-4ef6-95f6-ad5e991b8b8e",
            "e8b4670e-fda5-4c93-a8db-689e6881230c", "7d3bda26-1c97-4f31-a8fa-1df8fbd83dc0",
            "ba6315cf-4c0d-42b4-827f-b9f29e1e34f5", "ef65e37a-7ae4-4389-9de0-c0d1ab7a9596",
            "c437b117-16b3-46b8-bae9-ac64948c8882", "6fc12759-a014-4aec-8cdb-50ae6ff18530",
            "88cfcc22-ce8b-4dab-8d42-2b9da92f29cf", "428ad0cb-6203-486d-be85-adb01c79578b",
            "b5504ee3-fb43-4bf2-83cc-23ecd0e0077b", "bce64f34-acee-415e-aceb-e3a38ddf476f",
            "fdec3d31-39f6-4615-9118-8c8dbe81ccbd", "61726e1b-bf42-4cab-910d-e5a226dec4f0",
            "793668a8-2c58-4e5e-b263-412d28d5703f", "841308a2-e761-498e-a4cc-0c3619791c19",
            "10c06cbe-7171-4d6f-bd06-8330a93e5d2e", "d9f4035c-cb0f-45af-9646-08e46b341b1f",
            "cfe0ee2e-8376-48b8-9f53-8a34cd073255", "1c50d2a2-990b-4897-a8c2-89a7a3202514",
            "a78aec93-5652-4b47-9a4e-865465b19ee6", "df537dc9-8358-4c28-9ab9-ddb8d364a9fc",
            "8fd22e52-5a44-4c30-9f96-282ea0c04a8c", "928e8a7a-b07a-400a-8ecd-f00af6ace96c",
            "c6045d32-c269-47ac-9d39-ce6be77c2015", "729711ba-ca1d-11eb-b8bc-0242ac130003",
            "7e16311c-d302-45da-afd9-98af90706ccb", "377a2e14-09ba-407d-9836-7267592a79ab",
            "d984b4b7-8bd2-456a-b082-6708b5454d23", "1a0f6b1d-513c-474c-b7ce-0ee1fbea8d02",
            "2fddff98-4a27-4d5f-83c8-1de977dd5a4e", "a9887522-31cb-429c-90d1-5f2f31bf10b8",
            "95951262-4878-4da9-86f0-188e5d1489b3", "429f9046-49e5-4b29-8818-295ec3814593",
            "86ca50e9-77ae-43a7-b646-8ce7794161a0", "7d6998c0-4fc5-4582-b9a4-3e93e73c4c24",
            "c73385ca-9ac4-439a-a625-bb473f450b49", "a8e9249d-3412-4dff-bfd4-758c66fd2f55",
            "decc7bbf-716c-44c1-9754-4356405fb9aa", "20923295-981b-4d3c-8ab8-aa149abfdb45",
            "56588f5b-e686-4cd1-bbc5-22a16a10f7eb", "ef4e1555-0136-4aae-9003-d9c8ca3e074e",
            "d9923de9-de6a-41ea-a63e-e8fd771b7b93", "39bbb587-62e4-4e77-8455-7556f74bc6fd",
            "8c426cdc-0545-42a7-a292-83f297cf7427", "5b0d3990-7459-4a82-abe1-ee791d4d1bab",
            "005ebd00-00be-4830-8ff4-cb3853312585", "30d67ca7-8c8b-4dde-93ef-becd2ac2e223",
            "2d3e86f5-22d6-47e9-85ea-93be2b992e98", "c7e7e7c6-8d4a-4e3a-9b2e-1f2a3b4c5d6e",
        ...
        "Differential PluginID": [
            ...
            "d16cebd8-0783-411c-89b6-6010c262544a", "01227024-8c3f-4c63-9498-83d8c4eb85b5",
            "3388f90c-2060-4583-a3df-50e9734b67d6", "ee58980a-4884-4dee-861b-ca685b00d77b",
            "a5bd3c98-3582-4232-8ddd-653d5ff7f074", "d8c9b542-0f2d-4d7e-9774-c07bebe2eff6",
            "7c7094f9-6268-49a8-aea3-a952369a849d", "d22a84ac-412e-428a-a094-08d39360e68a",
            "d191c862-ae01-43a0-acfa-b670f1128ce3", "5d85d8e7-5141-42bc-8855-c25c913feed0",
            "c6521348-a7a9-49e8-8b27-2e845b29ea18", "12da5758-164c-4e00-af5a-e850c4403528",
            "545d5972-757f-49d2-be04-10e6df21a667", "194176cf-17e8-4a81-8436-c5704ef2a20a",
            "e49a4837-72d7-4175-80d9-bd4dc10bdd08", "627c8792-65b2-4484-8398-ac21b91fb07d",
            "063dced8-0e14-43f6-a1e9-a6261b316e50", "e19f7212-d517-43d9-9078-ee97b63fdd1d",
            "ee6afb72-7781-478f-9996-321611490c58", "dfad9cf9-dc5f-482e-87c6-5c69bdfca161",
            "341c1278-f32b-43c7-b29e-db4881a463f4", "8ce4c7b2-7313-4610-a98a-e8b6e11c70c0",
            "8532e304-e08e-469f-a503-172b1b93345b", "279cd3bf-70db-4f4d-be40-8183b54c8ee4",
            "1eaa086d-9073-4857-afc9-12dde5e8a93a", "91593014-7d61-4a04-adaf-54c86061ae43",
            "1dc1fc77-8906-4685-ad0c-66a841cb5142", "53198ba5-d30f-476b-bbb1-bbf9cdf1ed4c",
            "f931c869-db64-4c3c-a564-a3c54fa6598d", "1e11923c-267c-400b-bfb5-690ce15b2ff9",
            "b6660b04-aabe-4603-b415-c9520d7931fe", "28905553-dab1-405a-9ecc-8e33ee467e7e",
            "df4f3513-fe31-4564-8f5c-453269ab1613", "8d3ee4fc-2bc1-4708-abbe-450651c7ad24",
            "67795928-7917-4dec-b325-e8f308c178c2", "42846d2d-cce6-4215-ab21-4228a952a0db",
            "e0856750-abf2-4f1b-9c3a-ad82a0cfedc1", "11b43b24-560b-4ed4-bcba-5ae46d39b949",
            "bd785b7d-5177-4529-8df2-48bf6affdaf1", "a698893e-b831-403c-9da1-b23170220d3e",
            "64a40051-a995-4db1-805c-300b89130d6e", "39c598e7-ac6e-475b-a42a-219c60cb6f9f",
            "77c494d0-08e2-4fab-8228-65e9d01b5aa2", "17bec595-147d-4483-aee5-b52d7b8bd69a",
            "0dfe6caa-a8d4-4480-98be-00d74f62e7b9", "c1900ac5-b2be-4c6a-9dd6-0a3ec19ea3b1",
            "23a9bff4-5c9a-446b-bd4d-46a924369997", "d0d3c00a-ca1a-11eb-b8bc-0242ac130003",
            "ad64a823-099c-4f5d-ad56-0806daddc286", "c657a528-877d-40d9-b56a-3d3c5cf64ae1",
            "b87cfe45-ed94-4264-8c12-2f5a3f1f4011", "2127ae26-4ec6-4cfa-9dc7-fb741e3fbcfd",
            "d5a7d50d-2a82-41a1-9ccb-e806b6bfe865", "01d3b529-5929-4f54-8348-d9e92fdb726a",
            "545a5c59-eff6-4701-8050-fff99762e549", "99b375ed-9247-465b-9955-0313b800a07b",
            "41b95b72-7ad9-4c49-acad-b7ffe103ef45", "df5a8a7a-1fbc-4fad-bfc7-e928ec8073d8",
            "becb2eba-fecb-49f9-ada8-f06dd59ddc15", "436b1311-fe12-4939-a678-b2c108110b29",
            "80b76771-d99b-4261-84da-33c1895a0378", "44af38cf-2e49-4789-b2cc-ad50d1c0c32b",
            "fe38c3e3-33bc-41a0-843a-274614583925", "78a9687e-6407-43a2-91d0-60bd450c0b94",
            "1e0c21d7-7d3d-47c2-9fa2-0b00f3720371", "fa10ab40-f3c1-4774-a5e5-fae391b2901f",
            "bbeca5be-12b4-4bc8-8280-65ff4042d3fc", "44556e27-057d-451f-9227-2a6e1b30a19c",
    ...
    st.success(f"✅ Loaded {len(ref_df)} datasets with IDs")
